...
<body class="login">
	<div>
		...
		<div class="login_wrapper">
			<div class="animate form login_form" style="background: none;">

				<section class="login_content">
					<form class="login-form" method="post" id="login-form">
						<h1 style="color: #73879C;">Login Form</h1>
						...
						<div class="separator">
							<p class="change_link">New to site?
								<a href="<?php echo $this->request->base; ?>/MemberRegistration/"> <?php echo __("Create Account"); ?></a>
							</p>
