...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="col-md-6">
			<input type="text" autocomplete="off" name="end_date" id="endDate" class="form-control validate[required]" value="<?php echo ($edit)?$this->Gym->get_db_format(date($this->Gym->getSettings("date_format"),strtotime($data["end_date"]))) : "";?>">
		</div>	
		</div>
