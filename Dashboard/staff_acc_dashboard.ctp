						...
						<div class="overview__inner">
							<div class="overview-box clearfix">
								<div class="icon">
									...
									<a href="<?php echo $this->request->base . "/GymMember/memberList"; ?>"style="display: contents;">
								</div>
								<div class="text">
									<h2><?php echo $members; ?></h2>
									<span><?php echo __("Member"); ?></span>
								</div>
							</div>
						...
						<div class="overview__inner">
							<div class="overview-box clearfix">
								<div class="icon">
									...
									<a  href="<?php echo $this->request->base . "/staff-members/staff-list"; ?>" style="display: contents;">
								</div>
									<div class="text">
										<h2><?php echo $staff_members; ?></h2>
										<span><?php echo __("TrainerMember"); ?></span>
									</div>
							</div>
						...
						<div class="overview__inner">
							<div class="overview-box clearfix">
								<div class="icon">
									...
									<a href="<?php echo $this->request->base . "/gym-group/group-list"; ?>" style="display: contents;">
								</div>
								<div class="text">
									<h2><?php echo $groups; ?></h2>
									<span><?php echo __("Group"); ?></span>
								</div>
							</div>
							<div class="overview-chart">
					...
					<div class="overview-item overview-item--c4">
						<div class="overview__inner">
							...
							<div class="icon">
									...
									<a href="<?php echo $this->request->base . "/gym-message/inbox"; ?>" style="display: contents;">
								</div>
								<div class="text">
